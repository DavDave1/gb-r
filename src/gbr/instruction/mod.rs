...
impl Instruction {
    pub fn decode(memory: &[u8]) -> Result<Self, GbError> {
        ...
        let instr = match opcode {
            ...
            Opcode::CpB => Arithmetic(Cmp(B, Operand::Reg(A))),
            Opcode::CpC => Arithmetic(Cmp(C, Operand::Reg(A))),
            Opcode::CpD => Arithmetic(Cmp(D, Operand::Reg(A))),
            Opcode::CpE => Arithmetic(Cmp(E, Operand::Reg(A))),
            Opcode::CpH => Arithmetic(Cmp(H, Operand::Reg(A))),
            Opcode::CpL => Arithmetic(Cmp(L, Operand::Reg(A))),
            ...
            Opcode::Rst5 => Call(0x0020, Always),
